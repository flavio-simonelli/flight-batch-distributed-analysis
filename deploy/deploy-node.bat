...
(
echo {
echo   "Comment": "Creating aliases for HDFS and Spark",
echo   "Changes": [
echo     { "Action": "UPSERT", "ResourceRecordSet": { "Name": "hdfs-master.%PRIVATE_DOMAIN_NAME%", "Type": "CNAME", "TTL": 300, "ResourceRecords": [{ "Value": "master.%PRIVATE_DOMAIN_NAME%" }] } },
echo     { "Action": "UPSERT", "ResourceRecordSet": { "Name": "spark-master.%PRIVATE_DOMAIN_NAME%", "Type": "CNAME", "TTL": 300, "ResourceRecords": [{ "Value": "master.%PRIVATE_DOMAIN_NAME%" }] } }
echo   ]
echo }
) > "%DNS_BATCH_FILE%"
...
set "DNS_BATCH_FILE=%TEMP%\dns-airflow-aliases.json"
(
echo {
echo   "Comment": "Creating aliases for Livy",
echo   "Changes": [
echo     { "Action": "UPSERT", "ResourceRecordSet": { "Name": "livy-airflow.%PRIVATE_DOMAIN_NAME%", "Type": "CNAME", "TTL": 300, "ResourceRecords": [{ "Value": "airflow.%PRIVATE_DOMAIN_NAME%" }] } }
echo   ]
echo }
) > "%DNS_BATCH_FILE%"
...
(
echo {
echo   "Comment": "Creating aliases for Worker %N%",
echo   "Changes": [
echo     { "Action": "UPSERT", "ResourceRecordSet": { "Name": "hdfs-worker-%N%.%PRIVATE_DOMAIN_NAME%", "Type": "CNAME", "TTL": 300, "ResourceRecords": [{ "Value": "worker-%N%.%PRIVATE_DOMAIN_NAME%" }] } },
echo     { "Action": "UPSERT", "ResourceRecordSet": { "Name": "spark-worker-%N%.%PRIVATE_DOMAIN_NAME%", "Type": "CNAME", "TTL": 300, "ResourceRecords": [{ "Value": "worker-%N%.%PRIVATE_DOMAIN_NAME%" }] } }
echo   ]
echo }
) > "%DNS_BATCH_FILE%"
