...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.43\textwidth]{../graphs/DeploymentView}
...
Al contrario, il \textbf{Predicate Pushdown} richiede comunque che Spark acceda ai metadati del file Parquet per valutarne le statistiche.
...
Un aspetto metodologico cruciale per SAE emerge dal confronto diretto degli algoritmi nei grafici risultanti: l'applicazione dei differenti metodi di approssimazione ha portato a risultati pressoché molto simili sull'intero asse temporale.
Sebbene il T-Digest mostri un comportamento leggermente meno lineare sulla mediana rispetto alla maggiore precisione teorica del KLL, il divario numerico reale è del tutto trascurabile.
Considerando il dominio specifico del problema, in cui l'obiettivo è intercettare i trend macroscopici e la magnitudo dei ritardi orari, questa forte convergenza dei dati fa preferire l'utilizzo di un algoritmo più snello e performante come il T-Digest.
