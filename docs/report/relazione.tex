...
L'architettura di Sky Analytics Engine è stata concepita seguendo i rigidi principi della "Separation of Concerns" e della "Microservices-oriented Infrastructure".
...
Tramite la classe \texttt{FlightRepositoryFactory}, l'applicazione istanzia a runtime implementazioni specifiche (es. \texttt{HdfsFlightRepository}, \texttt{PostgresFlightRepository}, \texttt{CockroachFlightRepository}, \texttt{RedisFlightRepository}) basandosi su un file di configurazione YAML , gestiti attraverso la classe \texttt{ApplicationConfig.java}.
